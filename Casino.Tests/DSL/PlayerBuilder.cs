namespace Casino.Tests.DSL
{
    public class PlayerBuilder
    {
        ...
        public PlayerBuilder WithNewGameWithOneDice()
        {
            _player.Join(new Game(numberOfDices: 1));
            return this;
        }

        public PlayerBuilder WithNewGameWithTwoDice()
        {
            _player.Join(new Game(numberOfDices: 2));
            return this;
        }
